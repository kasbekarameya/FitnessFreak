...
public class suspToday extends JFrame implements ActionListener{
    JLabel current;
    JButton print;
    JButton close;
    JPanel panel_1;
...
Connection connection = DriverManager.getConnection( url );
			...
			String sql = "Select members.mid,name,cell_phone from suspend,members where members.mid=suspend.mid and end_date=?";
    ...
    public static void main(String args[]) {
        suspToday window = new suspToday();
        try {
