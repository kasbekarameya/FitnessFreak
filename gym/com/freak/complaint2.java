 ...
 //	table.setAutoResizeMode(AUTO_RESIZE_OFF);
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==add1)
		{
			...
			//	System.out.print("hooooooooaaaaa");
				try
				{
					DataInputStream sin=new DataInputStream(new FileInputStream("gym/cmp.dat"));
	...
	int resp = JOptionPane.showConfirmDialog(complaint2.this, "Are you sure you want to save?","Confirmation",JOptionPane.YES_NO_OPTION);
         switch(resp) {
			...
			DataInputStream dt=new DataInputStream(new FileInputStream("gym/cmp.dat"));
							...
							DataOutputStream out=new DataOutputStream(new FileOutputStream("gym/cmp.dat"));
							out.writeUTF(temp2);
							dt.close();
		...
		if(ae.getSource()==delete)
		{
			...
			{
				Icon warn=new ImageIcon("gym/error.png");
