...
public class mssgAppt extends JFrame implements ActionListener{
    JLabel current;
    JButton print;
    JButton close;
    JPanel panel_1;
    ...
    public mssgAppt() {
       ...
       current = new JLabel("Massage Appointments Today");
...
Connection connection = DriverManager.getConnection( url );
	...
	SwingUtilities.updateComponentTreeUI(window);
        ...
        window.setTitle("Massage Appointments Today");
        window.pack();
        window.show();
    }
