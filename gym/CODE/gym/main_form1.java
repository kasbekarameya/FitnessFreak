...
class main_form1 extends JFrame implements ActionListener,ItemListener
{
	...
	ResultSet resu;
	 ...
	 static gym.com.freak.newsusp1 ns=new gym.com.freak.newsusp1();
	 static gym.com.freak.memprog mp=new gym.com.freak.memprog();
...
//	JComboBox status1;
	...
	JButton srch;
			Icon check=new ImageIcon("gym/Check_h.gif");
	
	public main_form1()
	{
		
			Icon lock=new ImageIcon("gym/lock.gif");	
			Icon exit=new ImageIcon("gym/Exit.png");	
...
//		qt.setIcon(exit);
	...
	//	smem.addActionListener(this);
		...
		bar.setLayout(new FlowLayout(FlowLayout.LEFT,10,0));
       	...
       	new_mem=new ImageIcon("gym/add_reviewer.gif");
		calc=new ImageIcon("gym/icon6.jpg");
		save_img=new ImageIcon("gym/save.png");
		
		b_add=new ImageIcon("gym/add.png");
		b_close=new ImageIcon("gym/dust2.png");
		b_last=new ImageIcon("gym/last.png");
		b_next=new ImageIcon("gym/next.png");
		b_first=new ImageIcon("gym/first.png");
		b_previous=new ImageIcon("gym/previous.png");
		b_locker=new ImageIcon("gym/lock_off.png");
		b_reload=new ImageIcon("gym/load.png");
		b_refresh=new ImageIcon("gym/refresh.png");
		b_help=new ImageIcon("gym/lock_log.png");
		h_save=new ImageIcon("gym/Save_h.gif");
		h_add=new ImageIcon("gym/Add_h.gif");
		h_refresh=new ImageIcon("gym/Refresh_h.gif");
		b_can=new ImageIcon("gym/close.png");
	...
	public void saverec()
			...
			DataInputStream dt=new DataInputStream(new FileInputStream("gym/mem.dat"));
			...
			int len=coursename.length();
							...
							DataOutputStream out=new DataOutputStream(new FileOutputStream("gym/mem.dat"));
							out.writeUTF(temp2);
							dt.close();
	...
	public void actionPerformed(ActionEvent ae)
	{
			...
			try
				{
					...
					DataInputStream sin=new DataInputStream(new FileInputStream("gym/mem.dat"));
		...
		if(ae.getSource()==save_b)
		{
			...
			else if(home.getText().length()>11 || home.getText().length()<8)
			{
					...
					Icon error=new ImageIcon("gym/error.png");
			...
			{			
					...
					else if(train.isSelected())
					{
						...
						Icon infom=new ImageIcon("gym/info.png");
						if(pt=="N/A")
						{	
		...
		if(ae.getSource()==ccn)
		{
			gym.com.freak.diet.calorie2 cal2=new gym.com.freak.diet.calorie2();		
		...
		gym.com.reports.curcust2 cc=new gym.com.reports.curcust2();	
		...
		gym.com.freak.about abo=new gym.com.freak.about();	
		...
		{
			gym.com.reports.memover mov=new gym.com.reports.memover();
		...
		if(ae.getSource()==exp)
		{
			gym.com.reports.expense expen=new gym.com.reports.expense();
		...
		{
			gym.com.reports.installment install=new gym.com.reports.installment();
		...
		{
			gym.com.reports.noofprogs nop=new gym.com.reports.noofprogs();
		...
		if(ae.getSource()==om)
		{
			gym.com.reports.oweMoney money=new gym.com.reports.oweMoney();
		...
		if(ae.getSource()==pro)
		{
			gym.com.reports.profit prof=new gym.com.reports.profit();
	...
	/*	if(ae.getSource()==smem)
		{
			gym.com.reports.suspmember suspmemb=new gym.com.reports.suspmember();
		...
		catch(Exception e)
		{
			...
			if(ae.getSource()==epat)	
			{
				...
				gym.com.freak.eatingpattern ep=new gym.com.freak.eatingpattern();
			...
			if(ae.getSource()==hqst)	
			{
				...
				gym.com.freak.health_quest hquest=new gym.com.freak.health_quest();
			...
			if(ae.getSource()==shift)	
			{
				...
				gym.com.reports.shiftrep shiftr=new gym.com.reports.shiftrep();
			...
			if(ae.getSource()==suspo)	
			{
				...
				gym.com.reports.suspenover suspov=new gym.com.reports.suspenover();
			...
			if(ae.getSource()==nutri)	
			{
				...
				gym.com.reports.nutriAppt na=new gym.com.reports.nutriAppt();
			...
			if(ae.getSource()==cftr)	
			{
				...
				gym.com.reports.cftAppt ca=new gym.com.reports.cftAppt();
			...
			if(ae.getSource()==msg)	
			{
				...
				gym.com.reports.mssgAppt ma=new gym.com.reports.mssgAppt();
		...
		if(ae.getSource()==bday)	
		{
			...
			gym.com.reports.bdayremind bdayr=new gym.com.reports.bdayremind();
			...
			if(ae.getSource()==duedate)	
			{
				...
				gym.com.reports.duedate ddate=new gym.com.reports.duedate();
		...
		if(ae.getSource()==manual)	
		{
			try
			{
			Desktop.open(new File("gym/manual.pdf"));
			}
			catch(Exception e)
			{
				e.printStackTrace();
		...
		if(ae.getSource()==passconf)	
		{
			...
			gym.com.freak.pass ps=new gym.com.freak.pass();
		...
		if(ae.getSource()==repconf)	
		{
			...
			gym.com.freak.repass reps=new gym.com.freak.repass();
		...
		{
			gym.com.freak.holiday2 hol=new gym.com.freak.holiday2();
		...
		{
			gym.com.freak.prog_config1 pf=new gym.com.freak.prog_config1();
		...
		{
			gym.com.freak.emp_fin ef=new gym.com.freak.emp_fin();
		...
		{
			gym.com.freak.excer_fin exf=new gym.com.freak.excer_fin();
		...
		if(ae.getSource()==msr)	
		{
			gym.com.freak.measure ms=new gym.com.freak.measure();
		...
		{ 
			gym.com.freak.general_config genconfig=new gym.com.freak.general_config();
		...
		{
			gym.com.freak.appoint app=new gym.com.freak.appoint();
		...
		if(ae.getSource()==cft)	
		{
			gym.com.freak.fitnesstemp ft=new gym.com.freak.fitnesstemp();
