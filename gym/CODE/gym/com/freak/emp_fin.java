...
public class emp_fin extends JFrame implements ActionListener,ItemListener{
 ...
 JButton cancel;
	...
	del.setEnabled(false);
		...
		ImageIcon i = new ImageIcon("gym/calculator.png");
...
public void actionPerformed(ActionEvent ae)
	{
...

		{
				...
				try
				{
					DataInputStream sin=new DataInputStream(new FileInputStream("gym/emp.dat"));
		...
		if(ae.getSource()==del)
		{
         ...
         switch(resp) {
			...
			try
			{
				...
				if(del==1)
				{
				Icon tick=new ImageIcon("gym/Check_h.gif");
				...
				{
				Icon warn=new ImageIcon("gym/Warning_h.gif");
		...
		catch(Exception e)
		{
			...
			try
			{
				...
				{
					Icon error1=new ImageIcon("gym/error.gif");
				...
				DataInputStream dt=new DataInputStream(new FileInputStream("gym/emp.dat"));
							...
							DataOutputStream out=new DataOutputStream(new FileOutputStream("gym/emp.dat"));
							out.writeUTF(temp2);
							dt.close();
